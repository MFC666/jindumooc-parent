...
public class TestpaperResultV8 {
    private Integer id;
    ...
    private Integer migrateresultid;
    ...
    public Integer getMigrateresultid() {
        return migrateresultid;
    }

    public void setMigrateresultid(Integer migrateresultid) {
        this.migrateresultid = migrateresultid;
    }
}